        ...
        for images_dir, image_set_filename, annotations_dir in zip(images_dirs, image_set_filenames, annotations_dirs):
            ...
            for image_id in it:
                ...
                if not annotations_dir is None:
                    ...
                    #     print(annotations_dir + image_id  + '.xml')
                    #     soup = BeautifulSoup(f, 'xml')

                    in_file = os.path.join(annotations_dir, image_id + '.xml')
                    ...
                    objects = root.iter('object') # Get a list of all objects in this image.
                    # print(annotations_dir + image_id  + '.xml')
